module.exports = function (grunt) {
    ...
    let private_directory = grunt.option('C:\\Users\\maxjw\\AppData\\Local\\Screeps\\scripts\\192_168_86_200___21025\\default') || config.private_directory;
    ...
    grunt.initConfig({
        ...
        // Add version letiable using current timestamp.
        file_append: {
            versioning: {
                files: [
                    {
